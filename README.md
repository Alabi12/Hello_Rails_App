...
Feel free to check the [issues page](https://github.com/Alabi12/Hello_Rails_App/issues).
...
This project is [MIT](https://github.com/Alabi12/Hello_Rails_App/blob/main/LICENSE) licensed.
